...
using Plots
    ...
    for n in [5, 10, 15]
        p= rysujNnfx(f1, 0.0, 1.0, n; wezly=:rownoodlegle)
        title!("e^x stopnia $n")
    ...
    for n in [5, 10, 15]
        p=rysujNnfx(f2, -1.0, 1.0, n; wezly=:rownoodlegle)
    ...
    for n in [5, 10, 15]
        p=rysujNnfx(f3, -1.0, 1.0, n; wezly=:rownoodlegle)
        ...
        p=rysujNnfx(f3, -1.0, 1.0, n; wezly=:czebyszew)
    ...
    for n in [5, 10, 15]
        p=rysujNnfx(f4, -5.0, 5.0, n; wezly=:rownoodlegle)
        ...
        p=rysujNnfx(f4, -5.0, 5.0, n; wezly=:czebyszew)
