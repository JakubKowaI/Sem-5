...
public class CalculatorParser extends Parser {
	...
	public static class NegativeNumberContext extends ExprContext {
		...
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CalculatorVisitor ) return ((CalculatorVisitor<? extends T>)visitor).visitNegativeNumber(this);
			else return visitor.visitChildren(this);
		}
	}
	@SuppressWarnings("CheckReturnValue")
			...
			while ( _alt!=2 && _alt!=org.antlr.v4.runtime.atn.ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						match(HAT);
						setState(32);
						((PowerContext)_localctx).right = expr(5);
						}
						break;
					case 2:
						{
						...
						setState(35);
						((MulDivContext)_localctx).right = expr(4);
						}
						break;
					case 3:
						{
						...
						setState(38);
						((AddSubContext)_localctx).right = expr(3);
						}
						break;
					}
					} 
